	...
	public class GClass6
	{
		...
		private void method_11(SendAllianceInvitationMessage sendAllianceInvitationMessage_0)
		{
			if (this.gclass4_0.method_1() != null)
			{
				...
				if (allianceMemberEntry.GetAllianceRole() == LogicAvatarAllianceRole.ELDER)
				{
					AllianceInvitationSendFailedMessage allianceInvitationSendFailedMessage2 = new AllianceInvitationSendFailedMessage();
					allianceInvitationSendFailedMessage2.SetReason(AllianceInvitationSendFailedMessage.Reason.USER_BANNED);
		...
		// Token: 0x0600002C RID: 44 RVA: 0x000035E4 File Offset: 0x000017E4
		private bool method_12()
		{
			return DateTime.UtcNow.Subtract(this.dateTime_0).TotalSeconds >= 1.0;
		}

		// Token: 0x0600002D RID: 45 RVA: 0x0000361C File Offset: 0x0000181C
		[CompilerGenerated]
		...
		{
			// Token: 0x06000030 RID: 48 RVA: 0x000036E4 File Offset: 0x000018E4
