...
namespace ns0
{
	...
	{
		// Token: 0x0600003E RID: 62 RVA: 0x0000226B File Offset: 0x0000046B
		...
		// Token: 0x0600003F RID: 63 RVA: 0x00002E70 File Offset: 0x00001070
		...
		// Token: 0x06000041 RID: 65 RVA: 0x00002293 File Offset: 0x00000493
		...
		// Token: 0x06000043 RID: 67 RVA: 0x000022C4 File Offset: 0x000004C4
		private int method_4(byte[] byte_0, byte[] byte_1, int int_4)
		{
			return this.streamEncrypter_1.Encrypt(byte_0, byte_1, int_4);
		}

		// Token: 0x06000044 RID: 68 RVA: 0x000022D4 File Offset: 0x000004D4
		...
		// Token: 0x06000046 RID: 70 RVA: 0x00002F2C File Offset: 0x0000112C
		...
		// Token: 0x06000047 RID: 71 RVA: 0x00002F88 File Offset: 0x00001188
		...
		// Token: 0x06000048 RID: 72 RVA: 0x00002FC8 File Offset: 0x000011C8
		public int method_9(byte[] byte_0, int int_4)
		{
			if (int_4 >= 7)
			{
				...
				if (int_4 - 7 >= num2)
				{
					...
					else if (this.enum0_0 == GClass5.Enum0.const_1)
					{
						if (num == 10100)
						{
		...
		// Token: 0x06000049 RID: 73 RVA: 0x000022DD File Offset: 0x000004DD
		...
		// Token: 0x0600004A RID: 74 RVA: 0x00003160 File Offset: 0x00001360
		public void method_11(PiranhaMessage piranhaMessage_0)
		{
			...
			else if (this.enum0_0 != GClass5.Enum0.const_0)
			{
			...
			this.gclass3_0.method_18(array2, num + 7);
		}
		...
		// Token: 0x0600004C RID: 76 RVA: 0x000022F3 File Offset: 0x000004F3
		...
		// Token: 0x0600004D RID: 77 RVA: 0x000032C0 File Offset: 0x000014C0
