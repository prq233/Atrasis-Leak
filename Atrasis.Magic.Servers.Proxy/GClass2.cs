...
namespace ns0
{
	...
	public static class GClass2
	{
		...
		// Token: 0x0600001C RID: 28 RVA: 0x000029E0 File Offset: 0x00000BE0
		...
		private static long smethod_3()
		{
			...
			{
				num = GClass2.long_0;
				GClass2.long_0 = (GClass2.long_0 + 1L & 36028797018963967L);
			}
			while (GClass2.concurrentDictionary_0.ContainsKey(num));
			return (long)ServerCore.Id << 55 | num;
		}

		// Token: 0x0600001E RID: 30 RVA: 0x00002A88 File Offset: 0x00000C88
		public static GClass1 smethod_4(GClass3 gclass3_0, AccountDocument accountDocument_0)
		{
			long key = GClass2.smethod_3();
		...
		public static bool smethod_5(long long_1, out GClass1 gclass1_0)
		{
