...
namespace ns0
{
	...
	public class GClass1 : ServerSession
	{
		...
		public void method_2(ServerSocket serverSocket_0, BindServerSocketRequestMessage bindServerSocketRequestMessage_0 = null)
		{
		...
		public void method_3(int int_1, bool bool_1 = true)
		{
		...
		// Token: 0x06000015 RID: 21 RVA: 0x00002156 File Offset: 0x00000356
		public ServerSocket method_4(int int_1)
		{
		...
		public void method_5()
		{
			if (this.bool_0 && this.m_sockets[6] == null && (this.int_0 == -1 || TimeUtil.GetTimestamp() > this.int_0))
			{
				...
				if (nextSocket != null)
				{
					this.method_2(nextSocket, null);
				}
			}
		}

		// Token: 0x06000017 RID: 23 RVA: 0x00002160 File Offset: 0x00000360
