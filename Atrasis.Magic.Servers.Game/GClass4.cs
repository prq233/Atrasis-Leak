...
namespace ns0
{
	...
	{
		// Token: 0x0600003A RID: 58 RVA: 0x00003930 File Offset: 0x00001B30
		...
		// Token: 0x0600003B RID: 59 RVA: 0x00003A54 File Offset: 0x00001C54
		...
		// Token: 0x0600003C RID: 60 RVA: 0x00003A9C File Offset: 0x00001C9C
		...
		// Token: 0x0600003D RID: 61 RVA: 0x00003B34 File Offset: 0x00001D34
		...
		// Token: 0x0600003E RID: 62 RVA: 0x00003B94 File Offset: 0x00001D94
		private static void smethod_3(GameHomeProtectionUpdateMessage gameHomeProtectionUpdateMessage_0)
		{
			...
			{
				gclass.UpdateProtection();
				if (gameHomeProtectionUpdateMessage_0.ShieldTime != -1)
				{
					gclass.LogicClientHome.SetShieldDurationSeconds(gameHomeProtectionUpdateMessage_0.ShieldTime);
				}
				if (gameHomeProtectionUpdateMessage_0.GuardTime != -1)
				{
					gclass.LogicClientHome.SetGuardDurationSeconds(gameHomeProtectionUpdateMessage_0.GuardTime);
				}
			}
		}

		// Token: 0x0600003F RID: 63 RVA: 0x00003BEC File Offset: 0x00001DEC
		...
		// Token: 0x06000041 RID: 65 RVA: 0x00003C78 File Offset: 0x00001E78
		...
		// Token: 0x06000044 RID: 68 RVA: 0x00003D28 File Offset: 0x00001F28
		...
		// Token: 0x06000045 RID: 69 RVA: 0x00003DA4 File Offset: 0x00001FA4
		...
		// Token: 0x06000046 RID: 70 RVA: 0x00003DEC File Offset: 0x00001FEC
		...
		// Token: 0x06000047 RID: 71 RVA: 0x00003E30 File Offset: 0x00002030
		...
		// Token: 0x06000048 RID: 72 RVA: 0x00003FA8 File Offset: 0x000021A8
		...
		// Token: 0x06000049 RID: 73 RVA: 0x000040A4 File Offset: 0x000022A4
		...
		// Token: 0x0600004A RID: 74 RVA: 0x000041D4 File Offset: 0x000023D4
		...
		private static void smethod_14(GameStateCallbackMessage gameStateCallbackMessage_0)
		{
			...
			if (GClass7.smethod_4(gameStateCallbackMessage_0.AccountId, out gclass))
			{
				...
				if (gameStateCallbackMessage_0.HomeJSON != null)
				{
					...
					gclass.UpdateProtection();
					gclass.LogicClientHome.GetCompressibleHomeJSON().Set(gameStateCallbackMessage_0.HomeJSON);
		...
		// Token: 0x0600004D RID: 77 RVA: 0x00004494 File Offset: 0x00002694
		private static void smethod_16(ForwardLogicRequestMessage forwardLogicRequestMessage_0)
		{
			...
			if (!piranhaMessage.IsServerToClientMessage() && piranhaMessage.GetMessageType() == 14325)
			{
				...
				if (GClass7.smethod_4(logicLong, out gclass))
				{
					...
					avatarProfileFullEntry.SetCompressedHomeJSON(gclass.LogicClientHome.GetCompressibleHomeJSON().GetCompressed());
		...
		// Token: 0x0600004E RID: 78 RVA: 0x000045B0 File Offset: 0x000027B0
			...
			if (GClass2.smethod_4(changeGameStateMessage_0.SessionId, out @class.gclass1_0))
			{
				...
				case GameStateType.NPC_ATTACK:
					...
					@class.gclass1_0.method_24(new GameNpcAttackState
					{
						...
						Home = GClass11.smethod_2()[changeGameStateMessage_0.NpcData.GetInstanceID()],
				...
				case GameStateType.CHALLENGE_ATTACK:
				{
					...
					logicClientHome.SetHomeId(changeGameStateMessage_0.ChallengeHomeId);
					logicClientHome.GetCompressibleHomeJSON().Set(changeGameStateMessage_0.ChallengeHomeJSON);
		...
		// Token: 0x06000050 RID: 80 RVA: 0x0000486C File Offset: 0x00002A6C
		...
		// Token: 0x06000051 RID: 81 RVA: 0x000048B0 File Offset: 0x00002AB0
		...
		// Token: 0x06000052 RID: 82 RVA: 0x000048FC File Offset: 0x00002AFC
		private static void smethod_21(GameStartFakeAttackMessage gameStartFakeAttackMessage_0)
		{
			...
			if (GClass2.smethod_4(gameStartFakeAttackMessage_0.SessionId, out @class.gclass1_0))
			{
				...
				if (gameState != null && gameState.GetGameStateType() == GameStateType.HOME)
				{
					...
					{
						Home = GClass8.smethod_3((LogicGameObjectData)gameStartFakeAttackMessage_0.ArgData),
		...
		// Token: 0x06000053 RID: 83 RVA: 0x000049F4 File Offset: 0x00002BF4
		...
		// Token: 0x06000054 RID: 84 RVA: 0x00004AB4 File Offset: 0x00002CB4
		...
		{
			// Token: 0x06000058 RID: 88 RVA: 0x00004B50 File Offset: 0x00002D50
		...
		{
			// Token: 0x0600005A RID: 90 RVA: 0x00004C74 File Offset: 0x00002E74
			internal void method_0(ServerRequestArgs serverRequestArgs_0)
			{
		...
		{
			// Token: 0x0600005E RID: 94 RVA: 0x00004E3C File Offset: 0x0000303C
			internal void method_0(ServerRequestArgs serverRequestArgs_0)
			{
				if (this.gclass1_0.IsDestructed())
				{
