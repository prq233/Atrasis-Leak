...
namespace ns0
{
	...
	public static class GClass10
	{
		...
		// Token: 0x06000098 RID: 152 RVA: 0x000063F4 File Offset: 0x000045F4
		...
		private static GClass5 smethod_2(GClass10.Class10 class10_0)
		{
			...
			int num3 = 50 + LogicMath.Clamp(num * (num2 - 50) / 30, 0, num2 - 50);
		...
		{
			return int_1 >= 5 && int_0 < 4000 && ServerCore.Random.Rand(100000) >= 96000 + int_0;
		}
		...
		// Token: 0x0600009C RID: 156 RVA: 0x00002634 File Offset: 0x00000834
		...
		// Token: 0x0600009D RID: 157 RVA: 0x00006668 File Offset: 0x00004868
		...
		// Token: 0x0600009E RID: 158 RVA: 0x000066A0 File Offset: 0x000048A0
		...
		{
			// Token: 0x0600009F RID: 159 RVA: 0x00002665 File Offset: 0x00000865
