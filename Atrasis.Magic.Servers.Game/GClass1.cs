...
namespace ns0
{
	...
	public class GClass1 : ServerSession
	{
		...
		// Token: 0x06000016 RID: 22 RVA: 0x00002C74 File Offset: 0x00000E74
		...
		// Token: 0x06000017 RID: 23 RVA: 0x00002D40 File Offset: 0x00000F40
		private void method_16(ServerRequestArgs serverRequestArgs_0)
		{
			if (serverRequestArgs_0.ErrorCode == ServerRequestError.Success && serverRequestArgs_0.ResponseMessage.Success)
			{
				...
				{
					Logging.Error("GameSession.onHomeServerBound: the duel could not be completed.");
		...
		// Token: 0x06000018 RID: 24 RVA: 0x00002E1C File Offset: 0x0000101C
		...
		// Token: 0x0600001A RID: 26 RVA: 0x00002EBC File Offset: 0x000010BC
		...
		// Token: 0x0600001E RID: 30 RVA: 0x00002F4C File Offset: 0x0000114C
		...
		// Token: 0x0600001F RID: 31 RVA: 0x00003028 File Offset: 0x00001228
		public void method_23()
		{
			this.method_1().UpdateProtection();
			this.method_24(new GameHomeState
			{
				Home = this.method_1().LogicClientHome,
				PlayerAvatar = this.method_1().LogicClientAvatar,
				SaveTime = this.method_1().SaveTime,
				MapId = this.method_1().MaintenanceTime,
				ServerCommands = this.method_1().ServerCommands
			});
		}

		// Token: 0x06000020 RID: 32 RVA: 0x000030A0 File Offset: 0x000012A0
		public void method_24(GameState gameState_1)
		{
			...
			@class.gameState_0.Home.GetCompressibleGlobalJSON().Set(ResourceManager.SERVER_SAVE_FILE_GLOBAL);
			@class.gameState_0.Home.GetCompressibleCalendarJSON().Set(ResourceManager.SERVER_SAVE_FILE_CALENDAR);
		...
		{
			// Token: 0x06000023 RID: 35 RVA: 0x00003194 File Offset: 0x00001394
