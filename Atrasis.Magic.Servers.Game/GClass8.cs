...
namespace ns0
{
	...
	public static class GClass8
	{
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00005758 File Offset: 0x00003958
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00005880 File Offset: 0x00003A80
		public static LogicClientHome smethod_3(LogicGameObjectData logicGameObjectData_0)
		{
			...
			logicClientHome.SetHomeJSON(LogicJSONParser.CreateJSONString(logicJSONObject, 2048));
			CompressibleStringHelper.Compress(logicClientHome.GetCompressibleHomeJSON());
			return logicClientHome;
		}

		// Token: 0x0600008D RID: 141 RVA: 0x00005E60 File Offset: 0x00004060
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00005F5C File Offset: 0x0000415C
