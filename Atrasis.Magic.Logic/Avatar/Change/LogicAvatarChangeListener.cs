...
namespace Atrasis.Magic.Logic.Avatar.Change
{
	...
	{
		// Token: 0x06001B22 RID: 6946 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void Destruct()
		{
		}

		// Token: 0x06001B23 RID: 6947 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void FreeDiamondsAdded(int count, int mode)
		{
		}

		// Token: 0x06001B24 RID: 6948 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void DiamondPurchaseMade(int type, int globalId, int level, int count, int villageType)
		{
		}

		// Token: 0x06001B25 RID: 6949 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void CommodityCountChanged(int commodityType, LogicData data, int count)
		{
		}

		// Token: 0x06001B26 RID: 6950 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void WarPreferenceChanged(int preference)
		{
		}

		// Token: 0x06001B27 RID: 6951 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void RevengeUsed(LogicLong id)
		{
		}

		// Token: 0x06001B28 RID: 6952 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void ExpPointsGained(int count)
		{
		}

		// Token: 0x06001B29 RID: 6953 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void ExpLevelGained(int count)
		{
		}

		// Token: 0x06001B2A RID: 6954 RVA: 0x00002465 File Offset: 0x00000665
		...
		// Token: 0x06001B34 RID: 6964 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void AllianceUnitRemoved(LogicCombatItemData data, int upgLevel)
		{
		}

		// Token: 0x06001B35 RID: 6965 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void AllianceUnitAdded(LogicCombatItemData data, int upgLevel)
		{
		}

		// Token: 0x06001B36 RID: 6966 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void AllianceUnitCountChanged(LogicCombatItemData data, int upgLevel, int count)
		{
		}

		// Token: 0x06001B37 RID: 6967 RVA: 0x00002465 File Offset: 0x00000665
		...
		// Token: 0x06001B38 RID: 6968 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void SetAllianceCastleLevel(int count)
		{
		}

		// Token: 0x06001B39 RID: 6969 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void KickPlayer(LogicLong playerId, string message)
		{
		}

		// Token: 0x06001B3A RID: 6970 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void SetTownHallLevel(int count)
		{
		}

		// Token: 0x06001B3B RID: 6971 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void SetVillage2TownHallLevel(int count)
		{
		}

		// Token: 0x06001B3C RID: 6972 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void DeliverableAllianceGift(LogicDeliverableGift deliverableGift)
		{
		}

		// Token: 0x06001B3D RID: 6973 RVA: 0x00002465 File Offset: 0x00000665
		public virtual void LegendSeasonScoreChanged(int state, int score, int scoreChange, bool bestSeason, int villageType)
		{
		}

		// Token: 0x06001B3E RID: 6974 RVA: 0x00002465 File Offset: 0x00000665
