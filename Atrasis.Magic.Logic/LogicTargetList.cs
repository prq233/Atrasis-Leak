...
namespace Atrasis.Magic.Logic
{
	...
	{
		// Token: 0x06000015 RID: 21 RVA: 0x00011FF4 File Offset: 0x000101F4
		...
		// Token: 0x06000017 RID: 23 RVA: 0x00012048 File Offset: 0x00010248
		public void Clear()
		{
			for (int i = 0; i < 10; i++)
			{
		...
		// Token: 0x06000018 RID: 24 RVA: 0x00012078 File Offset: 0x00010278
		...
		// Token: 0x06000019 RID: 25 RVA: 0x00012160 File Offset: 0x00010360
