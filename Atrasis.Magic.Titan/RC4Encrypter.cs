...
namespace Atrasis.Magic.Titan
{
	...
	{
		// Token: 0x06000001 RID: 1 RVA: 0x0000428C File Offset: 0x0000248C
		public RC4Encrypter(string baseKey, string nonce)
		{
			this.InitState(baseKey, nonce);
		}

		// Token: 0x06000002 RID: 2 RVA: 0x0000429C File Offset: 0x0000249C
		...
		// Token: 0x06000003 RID: 3 RVA: 0x0000535C File Offset: 0x0000355C
		...
		// Token: 0x06000004 RID: 4 RVA: 0x000042B9 File Offset: 0x000024B9
		public override int Decrypt(byte[] input, byte[] output, int length)
		{
			return this.Encrypt(input, output, length);
		}

		// Token: 0x06000005 RID: 5 RVA: 0x00005474 File Offset: 0x00003674
