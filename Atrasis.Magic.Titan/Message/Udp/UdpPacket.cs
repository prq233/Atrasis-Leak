...
namespace Atrasis.Magic.Titan.Message.Udp
{
	...
	{
		// Token: 0x06000038 RID: 56 RVA: 0x0000445C File Offset: 0x0000265C
		public UdpPacket()
		{
			this.logicArrayList_0 = new LogicArrayList<UdpMessage>();
		}

		// Token: 0x06000039 RID: 57 RVA: 0x00005978 File Offset: 0x00003B78
		...
		// Token: 0x0600003A RID: 58 RVA: 0x00005A20 File Offset: 0x00003C20
		...
		// Token: 0x0600003B RID: 59 RVA: 0x0000446F File Offset: 0x0000266F
		public void AddMessage(UdpMessage message)
		{
			this.logicArrayList_0.Add(message);
		}

		// Token: 0x0600003C RID: 60 RVA: 0x0000447D File Offset: 0x0000267D
		public LogicArrayList<UdpMessage> GetMessages()
		{
			return this.logicArrayList_0;
		}

		// Token: 0x0600003D RID: 61 RVA: 0x00004485 File Offset: 0x00002685
		public byte[] GetAckMessageIds()
		{
			return this.byte_0;
		}

		// Token: 0x0600003E RID: 62 RVA: 0x0000448D File Offset: 0x0000268D
		public int GetAckMessageIdCount()
		{
			return this.int_0;
		}

		// Token: 0x0600003F RID: 63 RVA: 0x00004495 File Offset: 0x00002695
