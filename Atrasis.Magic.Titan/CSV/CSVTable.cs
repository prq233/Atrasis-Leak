...
namespace Atrasis.Magic.Titan.CSV
{
	...
	{
		// Token: 0x0600016D RID: 365 RVA: 0x000051CC File Offset: 0x000033CC
		...
		// Token: 0x0600016E RID: 366 RVA: 0x000083AC File Offset: 0x000065AC
		...
		// Token: 0x0600016F RID: 367 RVA: 0x00005203 File Offset: 0x00003403
		public void AddColumn(string name)
		{
			this.logicArrayList_0.Add(name);
		}

		// Token: 0x06000170 RID: 368 RVA: 0x00005211 File Offset: 0x00003411
		public void AddColumnType(int type)
		{
			this.logicArrayList_1.Add(new CSVColumn(type, this.int_0));
		}

		// Token: 0x06000171 RID: 369 RVA: 0x0000522A File Offset: 0x0000342A
		public void AddRow(CSVRow row)
		{
			this.logicArrayList_2.Add(row);
		}

		// Token: 0x06000172 RID: 370 RVA: 0x00005238 File Offset: 0x00003438
		...
		// Token: 0x06000174 RID: 372 RVA: 0x00008448 File Offset: 0x00006648
		...
		// Token: 0x06000175 RID: 373 RVA: 0x00005263 File Offset: 0x00003463
		public string GetColumnName(int idx)
		{
			return this.logicArrayList_0[idx];
		}

		// Token: 0x06000176 RID: 374 RVA: 0x00005271 File Offset: 0x00003471
		public int GetColumnIndexByName(string name)
		{
			return this.logicArrayList_0.IndexOf(name);
		}

		// Token: 0x06000177 RID: 375 RVA: 0x0000527F File Offset: 0x0000347F
		public int GetColumnCount()
		{
			return this.logicArrayList_0.Size();
		}

		// Token: 0x06000178 RID: 376 RVA: 0x0000528C File Offset: 0x0000348C
		public int GetColumnRowCount()
		{
			return this.logicArrayList_1[0].GetSize();
		}

		// Token: 0x06000179 RID: 377 RVA: 0x0000529F File Offset: 0x0000349F
		public int GetColumnTypeCount()
		{
			return this.logicArrayList_1.Size();
		}

		// Token: 0x0600017A RID: 378 RVA: 0x000052AC File Offset: 0x000034AC
		public string GetFileName()
		{
			return this.csvnode_0.GetFileName();
		}

		// Token: 0x0600017B RID: 379 RVA: 0x000052B9 File Offset: 0x000034B9
		public bool GetBooleanValue(string name, int index)
		{
			return this.GetBooleanValueAt(this.logicArrayList_0.IndexOf(name), index);
		}

		// Token: 0x0600017C RID: 380 RVA: 0x000052CE File Offset: 0x000034CE
		...
		// Token: 0x0600017D RID: 381 RVA: 0x000052E8 File Offset: 0x000034E8
		public int GetIntegerValue(string name, int index)
		{
			return this.GetIntegerValueAt(this.logicArrayList_0.IndexOf(name), index);
		}

		// Token: 0x0600017E RID: 382 RVA: 0x000084C8 File Offset: 0x000066C8
		...
		// Token: 0x0600017F RID: 383 RVA: 0x000052FD File Offset: 0x000034FD
		public string GetValue(string name, int index)
		{
			return this.GetValueAt(this.logicArrayList_0.IndexOf(name), index);
		}

		// Token: 0x06000180 RID: 384 RVA: 0x00005312 File Offset: 0x00003512
		...
		// Token: 0x06000181 RID: 385 RVA: 0x00005330 File Offset: 0x00003530
		public CSVRow GetRowAt(int index)
		{
			return this.logicArrayList_2[index];
		}

		// Token: 0x06000182 RID: 386 RVA: 0x0000533E File Offset: 0x0000353E
		public CSVColumn GetCSVColumn(int index)
		{
			return this.logicArrayList_1[index];
		}

		// Token: 0x06000183 RID: 387 RVA: 0x0000534C File Offset: 0x0000354C
		public int GetRowCount()
		{
			return this.logicArrayList_2.Size();
		}

		// Token: 0x06000184 RID: 388 RVA: 0x000084FC File Offset: 0x000066FC
