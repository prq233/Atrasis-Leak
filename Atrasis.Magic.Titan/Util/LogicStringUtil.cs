...
namespace Atrasis.Magic.Titan.Util
{
	...
	{
		// Token: 0x0600001D RID: 29 RVA: 0x0000437B File Offset: 0x0000257B
		public static byte[] GetBytes(string str)
		{
			return Encoding.UTF8.GetBytes(str);
		}

		// Token: 0x0600001E RID: 30 RVA: 0x00004388 File Offset: 0x00002588
		public static string CreateString(byte[] value, int offset, int length)
		{
			return Encoding.UTF8.GetString(value, offset, length);
		}

		// Token: 0x0600001F RID: 31 RVA: 0x00004397 File Offset: 0x00002597
		public static int ConvertToInt(string value)
		{
			return LogicStringUtil.ConvertToInt(value, 0, value.Length);
		}

		// Token: 0x06000020 RID: 32 RVA: 0x00005814 File Offset: 0x00003A14
